...
These are real FigureCraft outputs. Select any image to inspect the checked-in
FigureSpec that produced it.

| Benchmark results | Agent system architecture | Neural-network plate |
| --- | --- | --- |
| [![A publication-ready scientific line chart generated by FigureCraft](docs/images/line-chart.svg)](skills/figurecraft/assets/examples/line-chart.json) | [![An evidence-driven agent architecture generated by FigureCraft](docs/images/agent-evidence-workflow.svg)](skills/figurecraft/assets/examples/agent-evidence-workflow.json) | [![A CNN architecture plate generated by FigureCraft](docs/images/cnn-architecture.svg)](skills/figurecraft/assets/examples/cnn-architecture.json) |
| Units, uncertainty, legends, and data checks | Semantic roles, routed connectors, and editable Draw.io | Tensor stages, residual paths, and publication sizing |
